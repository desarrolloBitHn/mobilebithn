...
/**
 * Generated class for the EmailmarketingPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-emailmarketing',
  templateUrl: 'emailmarketing.html',
})
export class EmailmarketingPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EmailmarketingPage');
  }
