...
/**
 * Generated class for the DiseñoartesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-diseñoartes',
  templateUrl: 'diseñoartes.html',
})
export class DiseñoartesPage {
  ...
  constructor(private _toast: ToastController, public http: HttpClient, public _storage: Storage, public formBuilder: FormBuilder, public nav: Nav, public navCtrl: NavController, public navParams: NavParams) {
    ...
    this.formulario.controls["title"].setValue("Cotización de Diseño Gráfico");
    this._listaimagenes.push("https://preview.ibb.co/bQ6Ah9/DISE_O_GRAFICO.jpg");
  }
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad DiseñoartesPage');
  }
